...
const Login = () => {
  ...
  <div className=''>
 <span className='text-none cursor-pionter text-2xl text-gray-500'>New to Netflix? <a href="./signup" className='text-none cursor-pionter text-2xl text-gray-200 font-semibold'>Sign up Now</a></span>
 </div>
    </form>
